...
def main_extract_subimages(args):
    ...
    opt['input_folder'] = osp.join(args.data_root, 'Input')
    opt['save_folder'] = osp.join(args.save_root, 'Input_sub')
...
def parse_args():
    ...
    parser.add_argument(
        '--data-root',
        default="/home/jq/Real/MGLD-VSR-main/dataset/VideoLQ",    #/home/jq/Trans/VSR-Transformer-main/data/REDS',
        type=str,
        help='root path for REDS')
    parser.add_argument(
        '--save_root',
        type=str,
        default='dataset/VideoLQ/',
