...
if __name__ == '__main__':
    ...
    t = torch.randn(5).cuda()

    net = InflatedUNetModelDualcondV2(num_frames=num_frames,
                                      ...
                                      semb_channels=semb_channels).cuda()

    # print(t.shape)
    struct_cond = torch.randn(5, 320, 64, 64).cuda()
    out = net(x, t, struct_cond=struct_cond)
    print(out.shape)