...
if __name__ == '__main__':
    ...
    import os
    yaml_path = '/home/jq/Real/MGLD-VSR-main/configs/realbasicvsr_config.yaml'
    opt = yaml_load(yaml_path)
    h, w, c = 512, 512, 3
    # gt_root = '/home/jq/Real/MGLD-VSR-main/dataset/REDS/train_sharp_sub'
    # lq_root = '/home/jq/Real/MGLD-VSR-main/dataset/REDS/train_degrade_sub'

    gt_root = '/home/jq/Real/MGLD-VSR-main/dataset/SPMCS/GT'
    lq_root = '/home/jq/Real/MGLD-VSR-main/dataset/SPMCS/GT_degrade'
    clip_list = sorted(os.listdir(gt_root))

    for clip in clip_list:
        clip_path = os.path.join(gt_root,clip)
        img_list = sorted(os.listdir(clip_path))
        for img in img_list:
            inp_path = os.path.join(clip_path, img)
            ...
            img_a = out_dict['lqs'][0]
            out_dir = os.path.join(lq_root, clip)
