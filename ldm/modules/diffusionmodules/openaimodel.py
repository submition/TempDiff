...
class ResBlock(TimestepBlock):
    ...
    def _forward(self, x, emb):
        # print("origin shape:################################",x.shape, emb.shape)
        if self.updown:
...
class InflatedUNetModelDualcondV2_init(nn.Module):
    """
    The full UNet model with attention and timestep embedding.
    :param in_channels: channels in the input Tensor.
    :param model_channels: base channel count for the model.
...
class InflatedEncoderUNetModelWT(nn.Module):
    ...
    def forward(self, x, timesteps):
        ...
        # print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$",len(result_list), len(self.fea_tran))
        # assert len(result_list) == len(self.fea_tran)
